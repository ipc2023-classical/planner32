...
SMASShrinkFH::~SMASShrinkFH() {
}

string SMASShrinkFH::name() const {
    return "f-preserving";
}
...
SMASShrinkStrategy *SMASShrinkFH::create_default(int max_states) {
    ...
    opts.set<int>("shrink_f", SMASShrinkFH::HIGH);
    opts.set<int>("shrink_h", SMASShrinkFH::LOW);
...
static Plugin<SMASShrinkStrategy> _plugin("shrink_fh", _parse);
